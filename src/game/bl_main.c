...
int BotInitLibrary(bot_library_t *lib)
{
	...
	cvar = gi.cvar("coopbot_leash", "1", 0);
	...
	cvar = gi.cvar("coopbot_personal_space", "0", 0);
	lib->funcs.BotLibVarSet("coopbot_personal_space", cvar->string);
	cvar = gi.cvar("coopbot_personal_space_radius", "96", 0);
	lib->funcs.BotLibVarSet("coopbot_personal_space_radius", cvar->string);
	cvar = gi.cvar("coopbot_fireline_avoid", "0", 0);
	lib->funcs.BotLibVarSet("coopbot_fireline_avoid", cvar->string);
	cvar = gi.cvar("coopbot_fireline_radius", "128", 0);
	lib->funcs.BotLibVarSet("coopbot_fireline_radius", cvar->string);
	cvar = gi.cvar("coopbot_doorway_avoid", "0", 0);
	lib->funcs.BotLibVarSet("coopbot_doorway_avoid", cvar->string);
	cvar = gi.cvar("coopbot_doorway_radius", "160", 0);
	lib->funcs.BotLibVarSet("coopbot_doorway_radius", cvar->string);
	...
	lib->funcs.BotLibVarSet("coopbot_burst_control", cvar->string);
	cvar = gi.cvar("coopbot_burst_shots", "4", 0);
	...
	lib->funcs.BotLibVarSet("coopbot_danger_threshold", cvar->string);
	cvar = gi.cvar("coopbot_danger_critical_health", "25", 0);
